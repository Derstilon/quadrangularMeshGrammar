...
from productions.decorators import first_isomorphism_for_p10
...
class P10:
    ...
    @staticmethod
    @first_isomorphism_for_p10(left)
    def apply(G: nx.Graph, isomorphism: Dict = None):
        ...
        E_chunks = P10.chunks(E_nodes[1:], 2)
